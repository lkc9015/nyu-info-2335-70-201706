import code ## to run the interact code line
import operator ## to sort the products, itemgetter
...
products = sorted(products, key=operator.itemgetter("name")) ## sorting products by name
